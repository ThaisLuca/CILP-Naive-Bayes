...
recursion_teamplayssport(louiscardinals,baseball).
recursion_teamplayssport(italy,golf).
recursion_teamplayssport(milwaukeebraves,baseball).
recursion_teamplayssport(washingtonuniversity,football).
recursion_teamplayssport(twins,hockey).
recursion_teamplayssport(americanuniversity,basketball).
recursion_teamplayssport(montanastateuniversity,basketball).
recursion_teamplayssport(osu,basketball).
recursion_teamplayssport(houstontexans,hockey).
recursion_teamplayssport(indians,baseball).
recursion_teamplayssport(iowastate,basketball).
recursion_teamplayssport(washingtonstate,hockey).
recursion_teamplayssport(fairfielduniversity,basketball).
recursion_teamplayssport(southeasternlouisianauniversity,basketball).
recursion_teamplayssport(carolinapanthers,football).
recursion_teamplayssport(westernkentuckyuniversity,basketball).
recursion_teamplayssport(idahostateuniversity,football).
recursion_teamplayssport(floridaintlgoldenpanthers,hockey).
recursion_teamplayssport(nyrangers,hockey).
recursion_teamplayssport(bills,football).
recursion_teamplayssport(kansascitychiefs,football).
recursion_teamplayssport(ballstateuniversity,football).
recursion_teamplayssport(chicagocubsbaseball,baseball).
recursion_teamplayssport(goldenstatewarriorsnba,basketball).
recursion_teamplayssport(redsox,baseball).
recursion_teamplayssport(houstonastros,baseball).
recursion_teamplayssport(cardinals,football).
recursion_teamplayssport(orlandomagic,basketball).
recursion_teamplayssport(georgiabulldogs,basketball).
recursion_teamplayssport(rutgers,basketball).
recursion_teamplayssport(washingtonnationals,baseball).
recursion_teamplayssport(kentuckywildcats,golf).
recursion_teamplayssport(sanjosestatespartans,basketball).
recursion_teamplayssport(jayhawks,baseball).
recursion_teamplayssport(atlantaflames,hockey).
recursion_teamplayssport(new,football).
recursion_teamplayssport(valparaisouniversity,basketball).
recursion_teamplayssport(harvardcrimson,hockey).
recursion_teamplayssport(stlouisrams,football).
recursion_teamplayssport(germany,golf).
recursion_teamplayssport(lsu,golf).
recursion_teamplayssport(cavaliers,basketball).
recursion_teamplayssport(buckeyes,golf).
recursion_teamplayssport(charlottebobcats,basketball).
recursion_teamplayssport(edmontonoilers,hockey).
recursion_teamplayssport(templeuniversity,basketball).
recursion_teamplayssport(bostonredsox,baseball).
recursion_teamplayssport(royals,hockey).
recursion_teamplayssport(niagarauniversity,basketball).
recursion_teamplayssport(pats,football).
recursion_teamplayssport(buccaneers,football).
recursion_teamplayssport(michiganstateuniversity,basketball).
recursion_teamplayssport(villanovauniversity,basketball).
recursion_teamplayssport(washingtonredskinslast,hockey).
recursion_teamplayssport(goldenbears,basketball).
recursion_teamplayssport(okcthunder,basketball).
recursion_teamplayssport(maryland,football).
recursion_teamplayssport(bostoncollege,basketball).
recursion_teamplayssport(detroittigers,baseball).
recursion_teamplayssport(manchesterunited,basketball).
recursion_teamplayssport(seahawks,football).
recursion_teamplayssport(santaclarauniversity,baseball).
recursion_teamplayssport(drexeluniversity,basketball).
recursion_teamplayssport(hartfordwhalers,hockey).
recursion_teamplayssport(division,tennis).
recursion_teamplayssport(indianauniversity,football).
recursion_teamplayssport(buffalobills,football).
recursion_teamplayssport(stlouiscardinals,baseball).
recursion_teamplayssport(washingtonbullets,basketball).
recursion_teamplayssport(derbycounty,basketball).
recursion_teamplayssport(towsonuniversity,lacrosse).
recursion_teamplayssport(pacers,basketball).
recursion_teamplayssport(merceruniversity,basketball).
recursion_teamplayssport(sanantonio,basketball).
recursion_teamplayssport(neworleanshornets,basketball).
recursion_teamplayssport(brazil,golf).
recursion_teamplayssport(bears,football).
recursion_teamplayssport(utahstateaggies,football).
recursion_teamplayssport(tampabaylightning,hockey).
recursion_teamplayssport(kanecountycougars,hockey).
recursion_teamplayssport(torontomapleleafs,hockey).
recursion_teamplayssport(missourivalleycollege,wrestling).
recursion_teamplayssport(sandiegopadres,baseball).
recursion_teamplayssport(oklahomasooners,basketball).
recursion_teamplayssport(sacramentokings,basketball).
recursion_teamplayssport(devils,hockey).
recursion_teamplayssport(bostonbraves,football).
recursion_teamplayssport(trailblazers,basketball).
recursion_teamplayssport(oaklandathletics,baseball).
recursion_teamplayssport(portlandtrailblazers,basketball).
recursion_teamplayssport(georgewashingtonuniversity,basketball).
recursion_teamplayssport(texaslonghorns,football).
recursion_teamplayssport(akron,basketball).
recursion_teamplayssport(middletennesseestateuniversity,basketball).
recursion_teamplayssport(tarheels,basketball).
recursion_teamplayssport(minnesotatimberwolves,basketball).
recursion_teamplayssport(mariners,baseball).
recursion_teamplayssport(wakeforestuniversityschoolofmedicine,football).
recursion_teamplayssport(oklahomastateuniversity,basketball).
recursion_teamplayssport(philadelphiaeagles,football).
recursion_teamplayssport(huskers,football).
recursion_teamplayssport(purdueuniversity,basketball).
recursion_teamplayssport(stlouisblues,hockey).
recursion_teamplayssport(wakeforestuniversity,football).
recursion_teamplayssport(bayloruniversity,football).
recursion_teamplayssport(michiganstatespartansmensbasketball,golf).
recursion_teamplayssport(baltimorebullets,basketball).
recursion_teamplayssport(spartans,golf).
recursion_teamplayssport(titans,football).
recursion_teamplayssport(ucirvine,basketball).
recursion_teamplayssport(olemiss,basketball).
recursion_teamplayssport(ladodgers,baseball).
recursion_teamplayssport(anaheimangels,baseball).
recursion_teamplayssport(brewers,baseball).
recursion_teamplayssport(torontobluejays,baseball).
recursion_teamplayssport(bucknelluniversity,basketball).
recursion_teamplayssport(packers,football).
recursion_teamplayssport(minnesotanorthstars,hockey).
recursion_teamplayssport(kansascityroyals,baseball).
recursion_teamplayssport(oaklandraiders,football).
recursion_teamplayssport(sanjosesharks,hockey).
recursion_teamplayssport(cavs,basketball).
recursion_teamplayssport(arizonadiamondbacks,baseball).
recursion_teamplayssport(newmexicostateuniversity,golf).
recursion_teamplayssport(hawks,basketball).
recursion_teamplayssport(raptors,basketball).
recursion_teamplayssport(dallasstars,hockey).
recursion_teamplayssport(denvernuggetsnba,basketball).
recursion_teamplayssport(sixers,basketball).
recursion_teamplayssport(harvard,football).
recursion_teamplayssport(detroitlions,football).
recursion_teamplayssport(jacksonvillestateuniversity,basketball).
recursion_teamplayssport(clemsonuniversity,football).
recursion_teamplayssport(floridagators,basketball).
recursion_teamplayssport(whitesox,baseball).
recursion_teamplayssport(arkansasstateuniversity,basketball).
recursion_teamplayssport(scarletknights,football).
recursion_teamplayssport(milwaukeebrewers,baseball).
recursion_teamplayssport(texaschristianuniversity,basketball).
recursion_teamplayssport(atlantabravesspringtraining,baseball).
recursion_teamplayssport(sdchargers,football).
recursion_teamplayssport(atlantathrashers,hockey).
recursion_teamplayssport(coloradostateuniversity,collegebaseball).
recursion_teamplayssport(indianastate,basketball).
recursion_teamplayssport(washingtonwizards,basketball).
recursion_teamplayssport(butleruniversity,basketball).
recursion_teamplayssport(baylorwomen,golf).
recursion_teamplayssport(boisest,basketball).
recursion_teamplayssport(denvernuggets,basketball).
recursion_teamplayssport(brooklyndodgersatebbetsfield,baseball).
recursion_teamplayssport(tampabaydevilrays,baseball).
recursion_teamplayssport(nets,basketball).
recursion_teamplayssport(mapleleafs,hockey).
recursion_teamplayssport(tampa,football).
recursion_teamplayssport(falcons,hockey).
recursion_teamplayssport(mavs,basketball).
recursion_teamplayssport(riceuniversity,basketball).
recursion_teamplayssport(stlouisblues,hockey).
recursion_teamplayssport(indianapacers,basketball).
recursion_teamplayssport(formersanfranciscogiants,hockey).
recursion_teamplayssport(bostonbruins,hockey).
recursion_teamplayssport(anaheimducks,hockey).
recursion_teamplayssport(ladodgers,baseball).
recursion_teamplayssport(france,golf).
recursion_teamplayssport(yaleuniversity,football).
recursion_teamplayssport(morganstateuniversity,basketball).
recursion_teamplayssport(goldengophers,basketball).
recursion_teamplayssport(unioncollege,basketball).
recursion_teamplayssport(easternkentuckyuniversity,basketball).
recursion_teamplayssport(baltimoreorioles,baseball).
recursion_teamplayssport(bluejays,baseball).
recursion_teamplayssport(cincinnatiroyals,basketball).
recursion_teamplayssport(seattlemariners,baseball).
recursion_teamplayssport(buckscountycommunitycollege,basketball).
recursion_teamplayssport(suns,basketball).
recursion_teamplayssport(hornedfrogs,football).
recursion_teamplayssport(chicagobulls,basketball).
recursion_teamplayssport(currentcapitals,hockey).
recursion_teamplayssport(northernmichiganuniversity,football).
recursion_teamplayssport(lakings,hockey).
recursion_teamplayssport(narizonadiamondbacks,baseball).
recursion_teamplayssport(montrealcanadiens,hockey).
recursion_teamplayssport(clevelandindians,baseball).
recursion_teamplayssport(miamidolphinsfootballteam,football).
recursion_teamplayssport(princetonuniversity,basketball).
recursion_teamplayssport(losangelesdodgers,baseball).
recursion_teamplayssport(redsoxthisseason,baseball).
recursion_teamplayssport(californiaangels,baseball).
recursion_teamplayssport(northeasternuniversity,basketball).
recursion_teamplayssport(philadelphiaflyers,hockey).
recursion_teamplayssport(chicagowhitesox,baseball).
recursion_teamplayssport(buffalosabres,hockey).
recursion_teamplayssport(pennstate,football).
recursion_teamplayssport(arkansasrazorbacks,golf).
recursion_teamplayssport(miamihurricanes,basketball).
recursion_teamplayssport(texasam,football).
recursion_teamplayssport(columbusbluejackets,hockey).
recursion_teamplayssport(philadelphiaphillies,baseball).
recursion_teamplayssport(wichitastateuniversity,basketball).
recursion_teamplayssport(kansasstateuniversity,football).
recursion_teamplayssport(olddominionuniversity,basketball).
recursion_teamplayssport(stateuniversity,golf).
recursion_teamplayssport(floridamarlinsteam,baseball).
recursion_teamplayssport(wildcats,basketball).
recursion_teamplayssport(floridainternationaluniversity,basketball).
recursion_teamplayssport(nyubobcats,basketball).
recursion_teamplayssport(kentstategoldenflashes,football).
recursion_teamplayssport(furmanuniversity,basketball).
recursion_teamplayssport(bengals,football).
recursion_teamplayssport(hokies,basketball).
recursion_teamplayssport(newyorkmets,baseball).
recursion_teamplayssport(manhattancollege,basketball).
recursion_teamplayssport(northernillinoisuniversity,basketball).
recursion_teamplayssport(georgemasonuniversity,basketball).
recursion_teamplayssport(georgetownuniversity,basketball).
recursion_teamplayssport(stlouishawks,basketball).
recursion_teamplayssport(virginiatech,football).
recursion_teamplayssport(montrealcanadians,hockey).
recursion_teamplayssport(eastcarolinauniversity,basketball).
recursion_teamplayssport(minnesotavikings,football).
recursion_teamplayssport(memphisgrizzliesnba,basketball).
recursion_teamplayssport(philadelphiawarriors,basketball).
recursion_teamplayssport(rockies,hockey).
recursion_teamplayssport(houstonoilers,football).
recursion_teamplayssport(vanderbiltuniversity,football).
recursion_teamplayssport(sandiegostateaztecsbasketball,basketball).
recursion_teamplayssport(westernkentuckyhilltoppers,golf).
recursion_teamplayssport(newenglandpatriots,football).
recursion_teamplayssport(losangelesraiders,football).
recursion_teamplayssport(pittsburghsteelerssunday,football).
recursion_teamplayssport(illini,basketball).
recursion_teamplayssport(yankees,baseball).
recursion_teamplayssport(losangelesangels,baseball).
recursion_teamplayssport(philadelphiaers,basketball).
recursion_teamplayssport(gonzagauniversity,basketball).
recursion_teamplayssport(dodgers,baseball).
recursion_teamplayssport(chicagoblackhawks,hockey).
recursion_teamplayssport(losangeleslakers,basketball).
recursion_teamplayssport(fairleighdickinsonuniversity,basketball).
recursion_teamplayssport(newyorkuniversity,football).
recursion_teamplayssport(harvarduniversity,basketball).
recursion_teamplayssport(newjerseydevils,hockey).
recursion_teamplayssport(atlantabraves,baseball).
recursion_teamplayssport(byu,hockey).
recursion_teamplayssport(ohiostateuniversity,basketball).
recursion_teamplayssport(ottawasenators,hockey).
recursion_teamplayssport(washingtonstateuniversity,basketball).
recursion_teamplayssport(jags,football).
recursion_teamplayssport(cincinnatiredstockings,baseball).
recursion_teamplayssport(southernmethodistuniversity,basketball).
recursion_teamplayssport(quebecnordiques,hockey).
recursion_teamplayssport(nyknicks,basketball).
recursion_teamplayssport(hawkeyes,basketball).
recursion_teamplayssport(pittsburghpirates,baseball).
recursion_teamplayssport(sanfranciscoers,football).
recursion_teamplayssport(stanford,football).
recursion_teamplayssport(georgiatech,baseball).
recursion_teamplayssport(buffalobraves,basketball).
recursion_teamplayssport(washingtoncapitals,hockey).
recursion_teamplayssport(westernillinoisuniversity,football).
recursion_teamplayssport(utahjazz,basketball).
recursion_teamplayssport(stlouiscardinals,baseball).
recursion_teamplayssport(jacksonvillejaguars,football).
recursion_teamplayssport(ucla,softball).
recursion_teamplayssport(texasrangers,baseball).
recursion_teamplayssport(laclippers,basketball).
recursion_teamplayssport(illinoiswesleyan,football).
recursion_teamplayssport(charlottehornets,basketball).
recursion_teamplayssport(chicagoblackhawks,hockey).
recursion_teamplayssport(duquesneuniversity,basketball).
recursion_teamplayssport(seattlesupersonicsandthunders,basketball).
recursion_teamplayssport(vancouvercanucks,hockey).
recursion_teamplayssport(iupui,basketball).
recursion_teamplayssport(yellowjackets,basketball).
recursion_teamplayssport(tulaneuniversityschoolofpublichealth,basketball).
recursion_teamplayssport(blackhawks,hockey).
recursion_teamplayssport(nashvillepredators,hockey).
recursion_teamplayssport(crew,basketball).
recursion_teamplayssport(texasamaggiesbasketball,football).
recursion_teamplayssport(sjsharks,hockey).
recursion_teamplayssport(cornhuskers,basketball).
recursion_teamplayssport(detroitpistonsnba,basketball).
recursion_teamplayssport(winnipegjets,hockey).
recursion_teamplayssport(maroons,hockey).
recursion_teamplayssport(coloradoavalanche,hockey).
recursion_teamplayssport(minnesotawilds,hockey).
recursion_teamplayssport(college,soccer).
recursion_teamplayssport(coloradorockies,baseball).
recursion_teamplayssport(byucougars,football).
recursion_teamplayssport(philadelphiaathletics,baseball).
recursion_teamplayssport(calgaryflames,hockey).
recursion_teamplayssport(phillies,hockey).
recursion_teamplayssport(universityofflorida,basketball).
recursion_teamplayssport(eagles,baseball).
recursion_teamplayssport(niners,hockey).
recursion_teamplayssport(drakeuniversity,football).
recursion_teamplayssport(dukebluedevils,basketball).
recursion_teamplayssport(creightonuniversity,basketball).
recursion_teamplayssport(nittanylions,football).
recursion_teamplayssport(hersheybears,hockey).
recursion_teamplayssport(georgiastateuniversity,basketball).
recursion_teamplayssport(newyorkjets,football).
recursion_teamplayssport(floridastateuniversity,basketball).
recursion_teamplayssport(losangelesangelsofanaheim,baseball).
recursion_teamplayssport(louisianastateuniversity,football).
recursion_teamplayssport(bostonuniversity,basketball).
recursion_teamplayssport(milwaukeebuckstickets,basketball).
recursion_teamplayssport(houstonrocketsnba,basketball).
recursion_teamplayssport(astroslastnight,hockey).
recursion_teamplayssport(lowellhighschool,football).
recursion_teamplayssport(northwesternuniversity,football).
recursion_teamplayssport(newjerseynets,basketball).
recursion_teamplayssport(spurs,basketball).
recursion_teamplayssport(broncos,hockey).
recursion_teamplayssport(mississippistateuniversity,football).
recursion_teamplayssport(oregonstate,football).
recursion_teamplayssport(ncstate,football).
recursion_teamplayssport(bostonceltics,basketball).
recursion_teamplayssport(stlouisbrowns,baseball).
recursion_teamplayssport(thomascollege,basketball).
recursion_teamplayssport(wesleywolverines,golf).
recursion_teamplayssport(dukeuniversity,basketball).
recursion_teamplayssport(rangers,hockey).
recursion_teamplayssport(cubbies,baseball).
recursion_teamplayssport(bluejackets,hockey).
recursion_teamplayssport(losangelesrams,football).
recursion_teamplayssport(dallasmavericks,basketball).
recursion_teamplayssport(saintlouisuniversity,basketball).
recursion_teamplayssport(vancouvergrizzlies,basketball).
recursion_teamplayssport(sienacollege,basketball).
recursion_teamplayssport(universityoftennesseeatmartin,basketball).
recursion_teamplayssport(manchestercity,basketball).
recursion_teamplayssport(usc,basketball).
recursion_teamplayssport(formerdetroitredwings,hockey).
recursion_teamplayssport(newyorkislanders,hockey).
recursion_teamplayssport(providencecollege,basketball).
recursion_teamplayssport(sundevils,hockey).
recursion_teamplayssport(notredame,basketball).
recursion_teamplayssport(maristcollege,basketball).
recursion_teamplayssport(minnesotatwins,baseball).
recursion_teamplayssport(kentuckywildcatsbasketball,golf).
recursion_teamplayssport(magic,basketball).
recursion_teamplayssport(arizonacardinals,football).
recursion_teamplayssport(holycross,basketball).
recursion_teamplayssport(howarduniversity,basketball).
recursion_teamplayssport(hornetscharlottebobcats,basketball).
recursion_teamplayssport(fresnostatebulldogs,baseball).
recursion_teamplayssport(californiastatepolytechnic,hockey).
recursion_teamplayssport(virginiamilitaryinstitute,football).
recursion_teamplayssport(arizonastateuniversity,baseball).
recursion_teamplayssport(missouristateuniversity,basketball).
recursion_teamplayssport(bruins,hockey).
recursion_teamplayssport(loyolamarymountuniversity,basketball).
recursion_teamplayssport(redwings,hockey).
recursion_teamplayssport(sandiegostateuniversity,basketball).
recursion_teamplayssport(cornelluniversity,basketball).
recursion_teamplayssport(hofstrauniversity,basketball).
recursion_teamplayssport(marlins,hockey).
recursion_teamplayssport(pittsburghpenguins,hockey).
recursion_teamplayssport(mightyducksofanaheim,hockey).
recursion_teamplayssport(mississippistate,basketball).
recursion_teamplayssport(columbiauniversity,football).
recursion_teamplayssport(rams,football).
recursion_teamplayssport(dallascowboys,football).
recursion_teamplayssport(marquetteuniversity,basketball).
recursion_teamplayssport(clevelandbrowns,football).
recursion_teamplayssport(tampabayrays,baseball).
recursion_teamplayssport(uweauclaire,football).
recursion_teamplayssport(ucriverside,basketball).
recursion_teamplayssport(baltimorecolts,football).
recursion_teamplayssport(pirates,hockey).
recursion_teamplayssport(fordhamuniversity,basketball).
recursion_teamplayssport(canisiuscollege,basketball).
recursion_teamplayssport(colgateuniversity,basketball).
recursion_teamplayssport(vols,golf).
recursion_teamplayssport(phoenixcoyotes,hockey).
recursion_teamplayssport(southernuniversity,football).
recursion_teamplayssport(ncaayouthkids,basketball).
recursion_teamplayssport(auburnuniversity,football).
recursion_teamplayssport(hornetsnbalive,basketball).
recursion_teamplayssport(northernarizonauniversity,basketball).
recursion_teamplayssport(bucs,football).
recursion_teamplayssport(evangeluniversity,football).
recursion_teamplayssport(wrightstateuniversity,basketball).
recursion_teamplayssport(wesleyanuniversity,football).
recursion_teamplayssport(carolinahurricaneshockey,hockey).
recursion_teamplayssport(northcarolinastateuniversity,basketball).
recursion_teamplayssport(concordiauniversity,basketball).
recursion_teamplayssport(princetondevilrays,football).
recursion_teamplayssport(gamecocks,basketball).
recursion_teamplayssport(alabamastateuniversity,basketball).
recursion_teamplayssport(westernmichiganuniversity,basketball).
recursion_teamplayssport(setonhalluniversity,basketball).
recursion_teamplayssport(ucsantabarbara,hockey).
recursion_teamplayssport(jamesmadisonuniversity,basketball).
recursion_teamplayssport(syracuseuniversity,football).
recursion_teamplayssport(jaguars,football).
